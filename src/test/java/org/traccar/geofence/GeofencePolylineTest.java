...
public class GeofencePolylineTest {
    ...
    public void testContainsPolyline1Interval() throws ParseException {
        ...
        assertTrue(geofenceGeometry.containsPoint(56.83801, 60.59748, 0));
        ((GeofencePolyline) geofenceGeometry).setDistance(15);
        assertTrue(!geofenceGeometry.containsPoint(56.83801, 60.59748, 0));
        assertTrue(geofenceGeometry.containsPoint(56.83801, 60.59748, 30));
    }
    ...
    public void testContainsPolyline3Intervals() throws ParseException {
        ...
        assertTrue(geofenceGeometry.containsPoint(56.83847, 60.60458, 0));
        assertTrue(geofenceGeometry.containsPoint(56.83764, 60.59725, 150));
        assertTrue(!geofenceGeometry.containsPoint(56.83764, 60.59725, 0));
        assertTrue(!geofenceGeometry.containsPoint(56.83861, 60.60822, 0));
    ...
    public void testContainsPolylineNear180() throws ParseException {
        ...
        assertTrue(geofenceGeometry.containsPoint(66.95, 180.0, 0));
        assertTrue(geofenceGeometry.containsPoint(66.96, 180.0, 2500));
        assertTrue(!geofenceGeometry.containsPoint(66.96, 180.0, 0));
        assertTrue(!geofenceGeometry.containsPoint(66.9509, -179.83, 0));
    }
}
