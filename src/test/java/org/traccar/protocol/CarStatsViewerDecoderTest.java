...
//	private static final String REQ_1 = REQ_START + "}";
	private static final String REQUEST_SIMPLE = REQ_START + "}";
			
//	private static final String REQ_2 = REQ_START + "," + DRIVING_POINTS + "}";
	private static final String REQUEST_WITH_DRIVING_POINTS = REQ_START + "," + DRIVING_POINTS + "}";
	...
	public void testWrongURI() throws Exception {
		testRequestNull("/any", REQUEST_SIMPLE);
	}

	@Test
	public void testeRequest() throws Exception {
		testRequestPosition(REQUEST_SIMPLE);
	}

	@Test
        public void testRequestWithDrivindPoints() throws Exception {
		testRequestPositions(REQUEST_WITH_DRIVING_POINTS);
		testRequestNull("/any", REQUEST_SIMPLE);
	}
